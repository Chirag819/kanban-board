...
export default function List(props) {
    const { groupBy, data } = useSelector((state) => (state.info))
    console.log(data)
    ...
    const getPriorityIcon = (listTitle) => {
        const priorityIcons = {
            ...
            <div className="list-container">
                <div className="list-header">
                    <div className="list-header-left">
                        {
                            groupBy === 'status' ? getStatusIcon(props.listTitle) : getPriorityIcon(props.listTitle)
                        }
